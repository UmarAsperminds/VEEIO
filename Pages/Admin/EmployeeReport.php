...
<div class="row">
    <div class="col-md-6">
        <div class="main-card mb-3 card">
            <div class="card-body"><h5 class="card-title">Employee Report</h5>
                <div class="row">
...
$(document).ready(function(){
    ...
    $.ajax({
        url:"Backend/Transport/AddGatePassController.php?LoadDriver",
    ...
    $('#ShowReport').on('click', function(){
        ...
        var table = $('#ReportTable').DataTable({
            ajax: {
                "url": 'Backend/Admin/ReportProcedure.php?EmployeeReport=true',
                "type" : "POST",
    ...
    $('#ReportTable tbody').on('click', 'td.details-control', function(){
        ...
        if ( row.child.isShown() ) {
            ...
            childTable = $('#Inner1_'+TableID).DataTable({
                dom: "t",
                ajax: {
                    url: 'Backend/Admin/ReportProcedure.php?EmployeeReportGatePassID=true&GatePassID='+rowData.GatePassID,
                    "dataSrc": function ( json ) {
                        console.log(json);
                        return json.data;
                    }
